...
[![ci](https://github.com/<your-username>/inference-router/actions/workflows/ci.yml/badge.svg)](https://github.com/<your-username>/inference-router/actions/workflows/ci.yml)
